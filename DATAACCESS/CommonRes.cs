...
//					}
//			
//					//小牛的预处理 order_prerefund_service 明文不带SPID 20091118
...
//								*/
//							DataAccess.MySqlAccess.WriteSqlLog(ICEServerIP.ToString(),serviceName,"返回包如下1:" + "[flag=]" + irt.flag + "[msg=]" + irt.Msg + "[replyinfo=]" + strReplyInfo);
//							return true;
//						}
//
//						//if(i == 49)
...
//					log.Info("返回包如下:" + strReplyInfo);
//					*/
//				DataAccess.MySqlAccess.WriteSqlLog(ICEServerIP.ToString(),serviceName,"返回包如下2:" + "[flag=]" + iResult + "[msg=]" + Msg + "[replyinfo=]" + strReplyInfo);
//
//				return true;
//			}
//			catch(Exception err)
...
//								log.Info("返回包如下:" + strReplyInfo);
//								*/
//							DataAccess.MySqlAccess.WriteSqlLog(ICEServerIP.ToString(),serviceName,"返回包如下:" + strReplyInfo);
//							return true;
//						}
//
//						//if(i == 49)
...
//				*/
//
//				DataAccess.MySqlAccess.WriteSqlLog(ICEServerIP.ToString(),serviceName,"调用ICE服务前失败" + err.Message);
//				return false;
//			}		
//		}
//
...
//		//					{
//		//						string tmpMsg="";
//		//						commRes.sendMail("andrewguo@tencent.com","andrewguo@tencent.com","调用ICE关闭异常","服务名："+fservicename+" 调用串："+frequestmsg+" 错误信息："+cerr.Message,"inner",out tmpMsg);
//		//					}
//		//					flag=temFlag;
//		//					
//		//				}
...
//		//				{
//		//					string tmpMsg="";
//		//					bool send=commRes.sendMail("andrewguo@tencent.com","andrewguo@tencent.com","调用ICE异常","调用ICE异常: " +Msg +" 服务名："+fservicename+" 调用串："+frequestmsg+" 错误信息："+err.Message,"inner",out tmpMsg);
//		//					if(!send)
//		//					{
