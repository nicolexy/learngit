<%@ Page language="c#" Codebehind="SettleInfoDetail.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.TradeManage.SettleInfoDetail" %>
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid1" runat="server" Width="900" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="settle_in" HeaderText="计划入账">
									<HeaderStyle Width="100px"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="actual_in" HeaderText="实际入账">
									<HeaderStyle Width="100px"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="refundfee" HeaderText="分账回退金额">
									<HeaderStyle Width="100px"></HeaderStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="freeze" HeaderText="冻结金额">
									<HeaderStyle Width="100px"></HeaderStyle>
								</asp:BoundColumn>
