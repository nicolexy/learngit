...
<%@ Page language="c#" Codebehind="CardInfoQuery.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.BaseAccount.CardInfoQuery" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CardInfoQuery</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table4" style="Z-INDEX: 101; LEFT: 16px; WIDTH: 1040px" cellSpacing="1" cellPadding="1"
				...
				<TR bgColor="#eeeeee">
					<TD colspan="2"><IMG height="16" src="../IMAGES/Page/post.gif" width="15">&nbsp;<asp:label id="lbTitle" runat="server" ForeColor="Red">卡信息查询</asp:label>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 16px; WIDTH: 1040px" cellSpacing="1" cellPadding="1"
				...
				<TR>
					<TD><asp:datagrid id="DataGrid1" runat="server" Width="100%" EnableViewState="False" PageSize="200"
							...
							<Columns>
                                <asp:BoundColumn DataField="Flistid" HeaderText="财付通订单"></asp:BoundColumn>
								<asp:BoundColumn DataField="Fbank_listid" HeaderText="银行订单"></asp:BoundColumn>
								<asp:BoundColumn DataField="Fcard_tail" HeaderText="银行卡号"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Fbuy_bank_type_str" HeaderText="银行类型"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Fpaynum_str" HeaderText="交易金额"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Fbuy_name" HeaderText="姓名"></asp:BoundColumn>
