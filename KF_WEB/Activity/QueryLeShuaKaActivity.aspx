	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="LEFT: 5%; POSITION: absolute; TOP: 5%" cellSpacing="1" cellPadding="1" width="820"
				border="1">
				<TR>
					<TD style="WIDTH: 100%" bgColor="#e4e5f7" colspan="4"><FONT face="宋体"><FONT color="red"><IMG height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;&nbsp;乐刷卡活动查询</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <TR>
                    ...
                    <TD><asp:DropDownList id="ddlActId" runat="server">
                        <asp:ListItem Value="lsk" Selected="True">乐刷卡活动</asp:ListItem>
                    </asp:DropDownList>
                    </TD>
			...
			<TABLE id="Table2" style="Z-INDEX: 102; LEFT: 5.02%; WIDTH: 85%; POSITION: absolute; TOP: 154px; HEIGHT: 35%"
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid1" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
								<asp:BoundColumn DataField="FUin" HeaderText="用户UIN"></asp:BoundColumn>
								<asp:BoundColumn DataField="FScene" HeaderText="场景ID"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FTransId" HeaderText="关联订单号"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FBitMaskStr" HeaderText="用户属性组合"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FStateStr" HeaderText="资格状态"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FPrizeId" HeaderText="奖品ID"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FDesc" HeaderText="奖品信息"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FErrorInfo" HeaderText="失败原因"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FCreateTime" HeaderText="资格获取时间"></asp:BoundColumn>
                                <asp:BoundColumn DataField="FPriEndDay" HeaderText="资格到期时间"></asp:BoundColumn>
							</Columns>
