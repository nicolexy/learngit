    ...
    public class Query_Service : System.Web.Services.WebService
    {
        ...
        */
        ...
        public void UpdateSubmitRefundState(string fid, int refundState,string batchNum)
        {
            ...
            {
                LogHelper.LogError(string.Format(" public void UpdateSubmitRefundState(string fid, int refundState,string batchNum):fid={0},异常：{1},提交sql={2}", fid, err.ToString(), sql));
                throw;
            }
            finally
            {
        ...
        public DataSet GetQueryListDetail(string listid)
        {
            try
            {
                ...
                string errMsg = "";
                DataSet ds = CommQuery.GetDataSetFromICE(cuser.ICESQL, "query_order_service", out errMsg);
