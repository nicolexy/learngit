...
<%@ Page language="c#" Codebehind="BankEmailManage.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.RefundManage.BankEmailManage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
					...
					<TD vAlign="top"><asp:datagrid id="DataGridGroup" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
                                ...
                                <asp:TemplateColumn HeaderText="删除">
									<ItemTemplate>
										<asp:LinkButton id="lbDelGroup" runat="server"  OnClientClick ="return confirm('确定要删除吗?')" CommandName="DeleteGroup">删除</asp:LinkButton>
									</ItemTemplate>
								</asp:TemplateColumn>
                                </Columns>
            ...
            <TABLE id="TableContacts" visible="false" style="Z-INDEX: 103; LEFT: 5.02%; WIDTH: 50%; POSITION:relative; top:70px;"
					...
					<TD vAlign="top"><asp:datagrid id="DataGridContacts" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
                                ...
                                <asp:BoundColumn DataField="Femail" HeaderText="电子邮件地址"></asp:BoundColumn>
                                  <asp:TemplateColumn HeaderText="删除">
									<ItemTemplate>
										<asp:LinkButton id="lbDelContacts" runat="server"   OnClientClick = "return confirm('确定要删除吗?') " CommandName="DeleteContacts">删除</asp:LinkButton>
									</ItemTemplate>
								</asp:TemplateColumn>
                                </Columns>
                            <PagerStyle HorizontalAlign="Right" ForeColor="#4A3C8C" BackColor="#E7E7FF" Mode="NumericPages"></PagerStyle>
               ...
               <TR>
                    <TD align="left"><asp:label id="Label10" runat="server">批量导入文件：</TD>
                 <TD></asp:label>&nbsp;<asp:FileUpload id="File1" runat="server" />
