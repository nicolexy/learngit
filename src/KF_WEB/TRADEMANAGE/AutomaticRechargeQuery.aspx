	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="LEFT: 5%; POSITION: absolute; TOP: 5%" cellSpacing="1" cellPadding="1" width="920"
				border="1">
				<TR>
					<TD style="WIDTH: 100%" bgColor="#e4e5f7" colspan="7"><FONT face="宋体"><FONT color="red"><IMG height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;&nbsp;自动充值查询</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</FONT>操作员代码: </FONT><SPAN class="style3"><asp:label id="Label1" runat="server" ForeColor="Red" Width="73px"></asp:label></SPAN></TD>
				</TR>
				
                <TR>
                    <TD align="right">财付通账号</TD>
			...
			<TABLE id="Table2" style="Z-INDEX: 102; LEFT: 5.02%; WIDTH: 85%; POSITION: absolute; TOP: 104px; HEIGHT: 35%"
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid1" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
								<asp:BoundColumn DataField="user_id" HeaderText="开通手机号"></asp:BoundColumn>
								<asp:BoundColumn DataField="threshold_amount_str" HeaderText="最低额度"></asp:BoundColumn>
                                <asp:BoundColumn DataField="bankType" HeaderText="扣款方式"></asp:BoundColumn>
                                <asp:BoundColumn DataField="withhold_uin" HeaderText="财付通账号"></asp:BoundColumn>
								<asp:ButtonColumn Text="充值记录" HeaderText="详情" CommandName="detail"></asp:ButtonColumn>
							</Columns>
            ...
            <TABLE id="Table3" cellSpacing="1" cellPadding="1" width="808" border="1" runat="server">
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid2" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<HeaderStyle Font-Bold="True" ForeColor="#F7F7F7" BackColor="#4A3C8C"></HeaderStyle>
							<Columns>
								<asp:BoundColumn DataField="trans_id_url" HeaderText="订单号"></asp:BoundColumn>
								<asp:BoundColumn DataField="bill_amount_str" HeaderText="充值金额"></asp:BoundColumn>
                                <asp:BoundColumn DataField="pay_amount_str" HeaderText="支付金额"></asp:BoundColumn>
                                <asp:BoundColumn DataField="user_id" HeaderText="充值手机"></asp:BoundColumn>
