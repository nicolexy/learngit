    ...
    <table id="Table1" style="z-index: 101; left: 5%; position: absolute; top: 5%" cellspacing="1"
        ...
        <tr>
            ...
            <td align="right" nowrap class="auto-style2">
                <asp:Label ID="Label6" runat="server">银行名称</asp:Label>
            </td>
            ...
            <td  colspan="2" align="right">
               日期：<asp:TextBox ID="TextBoxDate" runat="server" Width="160px" onClick="WdatePicker()"  CssClass="Wdate"></asp:TextBox>
            </td>
        </tr>
            ...
            <td valign="top">
                <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkColumn  Target="_blank" DataNavigateUrlField="Furl"  DataTextField="fbank_order" HeaderText="银行订单号">
