...
<%@ Page language="c#" Codebehind="UserControledFundPage.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.TradeManage.UserControledFundPage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table id="table1" border="1" cellSpacing="1" cellPadding="1" width="900" runat="server">
				...
				<tr>
					<td colSpan="2"><asp:label id="Label1" runat="server" Width="80" Font-Size="15px">帐号：</asp:label><asp:textbox id="txt_qqid" Width="250px" Runat="server"></asp:textbox>
                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblmemo" runat="server" Width="70" Font-Size="14px"></asp:Label>
					</td>
				</tr>				
				<tr>
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid_QueryResult" runat="server" Width="900px" BorderColor="#E7E7FF" BorderStyle="None"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="FstateName" HeaderText="物理状态">
			...
			<br>
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid_OperLog" runat="server" Width="900px" BorderColor="#E7E7FF" BorderStyle="None"
							BorderWidth="1px" BackColor="White" CellPadding="1" GridLines="Horizontal" AutoGenerateColumns="False"
							PageSize="5" HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
							<FooterStyle ForeColor="#4A3C8C" BackColor="#B5C7DE"></FooterStyle>
							<SelectedItemStyle Font-Bold="True" ForeColor="#F7F7F7" BackColor="#738A9C"></SelectedItemStyle>
