            ...
            <table cellspacing="1" cellpadding="1"  >
                ...
                <tr>
                    <td class="tb_query_title">姓名：</td>
                     <td> <asp:Label runat="server" ID="lbl_name"></asp:Label> </td> 
                    <td class="tb_query_title">国籍：</td>
                     <td><asp:Label runat="server" ID="lbl_country"> </asp:Label></td>
                </tr>
                <tr>
                    <td class="tb_query_title">生日：</td>
                     <td> <asp:Label runat="server" ID="lbl_birthday"></asp:Label> </td> 
                    <td class="tb_query_title">联系手机：</td>
                     <td><asp:Label runat="server" ID="lbl_mobile"> </asp:Label></td>
                </tr>
                <tr>
                    <td class="tb_query_title">证件类型：</td>
                     <td> <asp:Label runat="server" ID="lbl_cre_type"></asp:Label> </td> 
                    <td class="tb_query_title">实名制时间：</td>
                     <td><asp:Label runat="server" ID="lbl_modify_time"> </asp:Label></td>
                </tr>
                <tr>
                    <td class="tb_query_title">证件号码：</td>
                     <td> <asp:Label runat="server" ID="lbl_cre_id"></asp:Label> </td> 
                    <td class="tb_query_title">认证方式：</td>
                     <td><asp:Label runat="server" ID="lbl_type"> </asp:Label></td>
                </tr>
            </table>
                </asp:Panel>
        </div>
