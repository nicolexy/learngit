...
<%@ Page language="c#" Codebehind="FCRefundQuery.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.ForeignCurrencyPay.FCRefundQuery" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FCRefundQuery</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="margin:20px 100px;" cellSpacing="1" cellPadding="1" width="820"
				border="1">
				<TR>
					<TD style="WIDTH: 100%" bgColor="#e4e5f7" colspan="4"><FONT face="宋体"><FONT color="red"><IMG height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;&nbsp;退款查询</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <TR>
                    ...
                    <TD><asp:textbox id="txtspListID" style="WIDTH: 180px;" runat="server"></asp:textbox><Font color="red">*</Font></TD>
                     <TD align="right"><asp:label id="Label6" runat="server">退款状态：</asp:label></TD>
                    <TD><asp:dropdownlist id="ddl_state" runat="server" Width="152px">
							...
							<asp:ListItem Value="2">审批流程中</asp:ListItem>
							...
							<asp:ListItem Value="11">转入代发中</asp:ListItem>
                            <asp:ListItem Value="99">退款回滚</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
                <TR>
                    <TD align="right"><asp:label id="Label5" runat="server">退款日期时间：</asp:label></TD>
                    <TD colspan="3">
			...
			<TABLE id="Table2" style="Z-INDEX: 102;WIDTH: 85%;HEIGHT: 35%;margin:20px 100px;"
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid1" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="Fsp_billno" HeaderText="商家订单号"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Ftransaction_id" HeaderText="财付通订单号"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Fcreate_time_order" HeaderText="交易时间"></asp:BoundColumn>
