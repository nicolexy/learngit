	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="LEFT: 5%; POSITION: absolute; TOP: 5%" cellSpacing="1" cellPadding="1" width="820"
				border="1">
				<TR>
					<TD style="WIDTH: 100%" bgColor="#e4e5f7" colspan="4"><FONT face="宋体"><FONT color="red"><IMG height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;&nbsp;拒付查询</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid1" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
                                ...
                                <asp:BoundColumn DataField="Fcreate_time" HeaderText="查单时间"></asp:BoundColumn>
                                 <asp:BoundColumn DataField="Ftrade_cur_type_str" HeaderText="交易币种"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Ftrade_pre_freeze_fee_str" HeaderText="查单金额"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Ftrade_freeze_fee_str" HeaderText="冻结金额"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Ftrade_refund_fee_str" HeaderText="拒付退款金额"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="Fzw_process_state_str" HeaderText="财务处理状态"></asp:BoundColumn>
							</Columns>
