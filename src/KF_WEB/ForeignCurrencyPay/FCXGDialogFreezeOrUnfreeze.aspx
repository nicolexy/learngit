<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FCXGDialogFreezeOrUnfreeze.aspx.cs" Inherits="TENCENT.OSS.CFT.KF.KF_Web.ForeignCurrencyPay.FCXGDialogFreezeOrUnfreeze" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head runat="server">
    <title runat="server" id="pageTitle">冻结/解冻</title>
    <style type="text/css">
            ...
            <table class="tab_input" cellpadding="1" cellspacing="1">
                <tr>
                    <td width="30%">
                        ...
                        <span class="style3" runat="server" id="lb_title">冻结/解冻账户</span>
                    </td>
                    <td>
                ...
                <tr>
                    <td><span runat="server" id="lb_reason">冻结/解冻原因：</span></td>
                    <td>
                ...
                <tr>
                    <td align="center" colspan="2">
                        <asp:Button ID="Button1" runat="server" Text="冻结账户/解冻账户" OnClick="Button1_Click" OnClientClick="return confirm('确定'+(this.value)+'?')" />
