...
<%@ Page language="c#" Codebehind="FCardOrderQuery.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.ForeignCardPay.FCardOrderQuery" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FCardOrderQuery</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="Z-INDEX: 101;LEFT: 5%; position:relative;top:10px" cellSpacing="1" cellPadding="1" width="820"
				border="1">
				<TR>
					<TD style="WIDTH: 100%" bgColor="#e4e5f7" colspan="4"><FONT face="宋体"><FONT color="red"><IMG height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;&nbsp;外卡订单查询</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <TR>
                    ...
                    <TD><asp:dropdownlist id="ddl_state" runat="server" Width="152px">
                            ...
                            <asp:ListItem Value="3">待处理</asp:ListItem>
                ...
                <TR>
                    ...
                    <TD align="right"><asp:label id="Label7" runat="server">买方邮箱：</asp:label></TD>
                    <TD><asp:textbox id="txtEmail" style="WIDTH: 180px;" runat="server"></asp:textbox></TD>
				</TR>
				<TR>
                    <TD colspan="4" align="center"><Font color="red">*必填</Font>&nbsp;&nbsp;&nbsp;&nbsp;<asp:button id="btnQuery" runat="server" Width="80px" Text="查 询" onclick="btnQuery_Click"></asp:button>
				</TR>
			</TABLE>
            </br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid1" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
                                ...
                                <asp:BoundColumn DataField="Ftransaction_id" HeaderText="财付通订单号"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Fmodify_time" HeaderText="交易时间"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="Frisk_level_str" HeaderText="风控状态"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="Fuser_card_type" HeaderText="交易卡种"></asp:BoundColumn>
            ...
            <TABLE id="tableOrder" runat="server" cellSpacing="1" cellPadding="0" style="Z-INDEX: 103; position:relative;top:20px;LEFT: 5.02%; WIDTH: 85%; "  bgColor="black" border="0">
                ...
                <TR>
					...
					<TD style="WIDTH: 185px; HEIGHT: 20px" bgColor="#eeeeee" height="20"><FONT face="宋体">&nbsp;给银行订单号:</FONT></TD>
                ...
                <TR>
					<TD style="WIDTH: 125px; HEIGHT: 20px" bgColor="#eeeeee" height="20"><FONT face="宋体">&nbsp;风控状态</FONT></TD>
