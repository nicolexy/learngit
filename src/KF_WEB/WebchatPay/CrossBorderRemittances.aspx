        ...
        <div class="container">
            ...
            <table cellspacing="1" cellpadding="1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txt_start_date" onclick="WdatePicker()" class="Wdate" Width="170px"></asp:TextBox>
            ...
            <asp:Panel runat="server" ID="panDetail" Visible="false">
                <table cellspacing="1" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbl_accid"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbl_remit_type"></asp:Label>
                        </td>
                        <td class="tb_query_title">汇款金额（外币）：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_fx_amount"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">支付单号：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_wx_pay_id"></asp:Label>
                        </td>
                        <td class="tb_query_title">当日汇率：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_fx_rate"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">支付时间：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_pay_time"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款确认时间：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_accept_time"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">支付状态：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_pay_state"></asp:Label>
                        </td>
                        <td class="tb_query_title">提现时间：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_fetch_time"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">支付总金额：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_pay_amount"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方姓名：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_name"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">汇款状态：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_remit_state"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方生日：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_dob"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">汇款失败原因：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_error_desc"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方银行类型：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_bank_type"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">购汇金额（人民币）：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_cny_amount"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方银行代码：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_bank_code"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">手续费金额：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_fee_amount"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方银行名称：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_bank_name"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">汇款人地址：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_s_address"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方银行账号：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_bank_acc"> </asp:Label></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbl_r_phone_no"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">是否需要补全信息：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_inquiry"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方邮箱：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_email"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">是否已补全：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_replied"></asp:Label>
                        </td>
                        <td class="tb_query_title">收款方地址：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_r_address"> </asp:Label></td>
                    </tr>
                    <tr>
                        <td class="tb_query_title">补全信息原因：</td>
                        <td>
                            <asp:Label runat="server" ID="lbl_inq_reason"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lbl_inq_items"></asp:Label>
                        </td>
                        <td class="tb_query_title">&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
