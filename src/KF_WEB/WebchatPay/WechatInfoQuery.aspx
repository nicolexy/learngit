<%@ Page Language="c#" CodeBehind="WechatInfoQuery.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.WebchatPay.WechatInfoQuery" %>
                ...
                <table height="192" cellspacing="1" cellpadding="0" width="100%" align="center" border="0">
                    <tr bgcolor="#e4e5f7" background="../IMAGES/Page/bg_bl.gif">
                        <td background="../IMAGES/Page/bg_bl.gif" colspan="5" height="20">
                            <strong><font color="#ff0000">&nbsp;<img height="16" src="../IMAGES/Page/post.gif"
                                width="20">
                            </font></strong><font color="#ff0000">微信用户账户资料</font>
                            <div align="center">
                                <font face="宋体"></font>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="height: 3px" bgcolor="#ffffff" height="3">
                            ...
                            <asp:LinkButton runat="server" ID="lbtn_synName" ForeColor="blue">同步姓名</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 3px" width="20%" background="../IMAGES/Page/bk_white.gif" bgcolor="#eeeeee"
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style="height: 4px" bgcolor="#ffffff" height="4">
                             &nbsp;
                            <asp:Label ID="Label15_Useable" runat="server" Width="180px" ForeColor="Red"></asp:Label><font face="宋体"></font>
                        </td>
                    </tr>
                        ...
                        <td background="../IMAGES/Page/bg_bl.gif" bgcolor="#e4e5f7" colspan="3" height="20">
                            <font color="#ff0000">&nbsp;<img height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;
                                <asp:LinkButton ID="LKBT_TradeLog" runat="server" ForeColor="Red" OnClick="LKBT_TradeLog_Click">买家交易单</asp:LinkButton></font>|<span
                                    ...
                                    <asp:LinkButton ID="LKBT_TradeLog_Sale_Unfinished" runat="server" ForeColor="Black"
                                        OnClick="LKBT_TradeLog_Sale_Unfinished_Click">卖家未完成交易单</asp:LinkButton>|
