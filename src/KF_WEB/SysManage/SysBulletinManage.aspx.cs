...
namespace TENCENT.OSS.CFT.KF.KF_Web.SysManage
{
	...
	/// </summary>
	public partial class SysBulletinManage : TENCENT.OSS.CFT.KF.KF_Web.PageBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
                ...
                if (!classLibrary.ClassLib.ValidateRight("SystemManagement", this)) Response.Redirect("../login.aspx?wh=1");
			}
			catch
			{
