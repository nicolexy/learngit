...
<%@ Page language="c#" Codebehind="BulletinSendMail.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.SysManage.BulletinSendMail" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <TABLE  style="Z-INDEX: 101; LEFT: 5.02%;POSITION: relative; TOP: 20px; " cellSpacing="1" cellPadding="1" width="500"
				border="1">
               <TR>
					<TD align="right" width="70px"><FONT face="宋体">邮件正文：</FONT>
					</TD>
					<TD align="left"><asp:textbox id="tbmaintext" runat="server" Width="350px" Height="120px" TextMode="MultiLine"></asp:textbox><asp:requiredfieldvalidator id="Requiredfieldvalidator1" runat="server" ErrorMessage="请输入" ControlToValidate="tbmaintext"></asp:requiredfieldvalidator></TD>
				</TR>
                 <TR>
					<TD align="right" width="70px"><FONT face="宋体">邮件日期：</FONT>
					</TD>
