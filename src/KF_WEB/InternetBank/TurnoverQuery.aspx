<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TurnoverQuery.aspx.cs"
    Inherits="TENCENT.OSS.CFT.KF.KF_Web.InternetBank.TurnoverQuery" %>
        ...
        <tr style="background-color: #e4e5f7">
            <td colspan="3">
                <img src="../IMAGES/Page/post.gif" width="20" height="16" alt="" /><label style="color: Red;
                    padding-left: 30px">当月流水查询</label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <asp:DataGrid ID="DataGrid_QueryResult" runat="server" Width="800px" BorderColor="#E7E7FF"
                    ...
                    <Columns>
                      ...
                      <%--  <asp:BoundColumn DataField="state" HeaderText="流水状态"></asp:BoundColumn>--%>
                        ...
                        <asp:BoundColumn DataField="Fportal_waer" HeaderText="portal流水"></asp:BoundColumn>
