     ...
     <table border="1" cellspacing="1" cellpadding="1" width="1100">
         <tr>
             <td>
                 ...
                 <img onclick="tbx_beginDate.click()" src="../SCRIPTS/My97DatePicker/skin/datePicker.gif" style="width: 16px; height: 22px; cursor: pointer" alt="选择日期" />
                 <span>&nbsp;&nbsp;查询结束时间：</span>
                 <input type="text" runat="server" id="tbx_endDate" onclick="WdatePicker()" />
                 <img onclick="tbx_endDate.click()" src="../SCRIPTS/My97DatePicker/skin/datePicker.gif" style="width: 16px; height: 22px; cursor: pointer" alt="选择日期" />
