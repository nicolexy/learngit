...
namespace TENCENT.OSS.CFT.KF.KF_Web.NewQueryInfoPages
{
    ...
    /// QueryYTTrade 的摘要说明。
	/// </summary>
    public partial class QueryYTTrade : TENCENT.OSS.CFT.KF.KF_Web.PageBase
	{
		...
		private void ValidateDate()
		{
            ...
            if (ccftno == "" && cytno == "" && ctradeno == "" && cbuss_orderno == "")
            {
        ...
        private void BindData(int index)
		{
            ...
            DataSet ds = qs.GetYTTradeList(s_cftno, s_ytno, s_tradeno, s_bussorderno, s_begindate, s_enddate, start, max,"1");
			...
			if(ds != null && ds.Tables.Count >0)
			{
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    if (yt_no == "")
                    {
                        DataSet ht = qs.GetYTInfoList(qqid, "", "","1");
