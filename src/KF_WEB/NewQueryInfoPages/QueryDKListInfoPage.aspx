	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE border="1" cellSpacing="1" cellPadding="1" width="1300">
				<TR>
					<TD style="WIDTH: 100%" bgColor="#e4e5f7" colSpan="5"><FONT face="宋体"><FONT color="red"><IMG src="../IMAGES/Page/post.gif" width="20" height="16">&nbsp;&nbsp;代扣信息查询</FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td colspan="2"><FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT> <span>商户号：</span><asp:TextBox Runat="server" ID="tbx_spid"></asp:TextBox>
						...
						<asp:DropDownList id="ddl_state" runat="server">
							...
							<asp:ListItem Value="1">批次初始化</asp:ListItem>
							<asp:ListItem Value="2">批次记录失败</asp:ListItem>
							<asp:ListItem Value="3">批次待审批</asp:ListItem>
							<asp:ListItem Value="4">批次取消</asp:ListItem>
							<asp:ListItem Value="5">批次审核失败</asp:ListItem>
							<asp:ListItem Value="6">批次验证中</asp:ListItem>
							<asp:ListItem Value="7">批次处理中</asp:ListItem>
							<asp:ListItem Value="8">批次处理完</asp:ListItem>
							<asp:ListItem Value="9">处理结果全部成功</asp:ListItem>
							<asp:ListItem Value="10">处理结果部分成功</asp:ListItem>
							<asp:ListItem Value="11">处理结果全部失败</asp:ListItem>
							<asp:ListItem Value="12">后台预处理中</asp:ListItem>
							<asp:ListItem Value="13">预处理完成</asp:ListItem>
						</asp:DropDownList>
						<span>查询时间段：</span><asp:TextBox Runat="server" ID="tbx_beginDate"></asp:TextBox><asp:imagebutton id="ButtonBeginDate" runat="server" ImageUrl="../Images/Public/edit.gif" CausesValidation="False"></asp:imagebutton>
						<span>到：</span><asp:TextBox Runat="server" ID="tbx_endDate"></asp:TextBox><asp:imagebutton id="ButtonEndDate" runat="server" ImageUrl="../Images/Public/edit.gif" CausesValidation="False"></asp:imagebutton>
					</td>
				</tr>
				<tr>
					<td colSpan="5" align="left">
                       &nbsp;&nbsp; <span>商户批次号：</span><asp:TextBox Runat="server" ID="tbx_spBatchID"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;<span>财付通批次号：</span><asp:TextBox Runat="server" ID="tbx_batchid"></asp:TextBox>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:button id="btn_serach" Width="80px" Text="查询" Runat="server" onclick="btn_serach_Click"></asp:button></td>
				</tr>
			</TABLE>
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="DataGrid_QueryResult" runat="server" Width="1300px" BorderColor="#E7E7FF" BorderStyle="None"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="Ftotal_paynumName" HeaderText="批次总金额"></asp:BoundColumn>								
								<asp:HyperLinkColumn Target="_blank" DataNavigateUrlField="totalBatchUrl" DataTextField="Ftotal_count"
									HeaderText="批次总笔数"></asp:HyperLinkColumn>
