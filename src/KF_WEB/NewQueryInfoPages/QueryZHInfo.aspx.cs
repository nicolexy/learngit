...
namespace TENCENT.OSS.CFT.KF.KF_Web.NewQueryInfoPages
{
    ...
    /// QueryYTInfo 的摘要说明。
	/// </summary>
    public partial class QueryZHInfo : TENCENT.OSS.CFT.KF.KF_Web.PageBase
	{
        ...
        private void BindData()
		{
            ...
            DataSet ht = qs.GetYTInfoList(s_cftno, s_ytno, s_begindate,"2");
            ...
            if (ht != null && ht.Tables.Count>0)
            {
                ...
                string authAmount_str = classLibrary.setConfig.FenToYuan(dt.Rows[0]["authAmount"].ToString());
                ...
                lb_c17.Text = "";//可用余额
                lb_c18.Text = "";//冻结金额
                lb_c21.Text = authAmount_str;//支付额度
        ...
        private void BindData2()
        {
            ...
            Query_Service.Query_Service qs = new TENCENT.OSS.CFT.KF.KF_Web.Query_Service.Query_Service();
            DataSet ht = qs.GetCertNum(s_certno,"2");
