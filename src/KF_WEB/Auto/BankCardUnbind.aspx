...
<%@ Page language="c#" Codebehind="BankCardUnbind.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.BaseAccount.BankCardUnbind" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="POSITION: absolute; TOP: 5%; LEFT: 5%" id="Table1" border="1" cellSpacing="1"
				...
				<asp:panel id="PanelList" runat="server">
						...
						<TD colSpan="4" align="center">
							<asp:datagrid id="Datagrid1" runat="server" Width="100%" BorderColor="#E7E7FF" BorderStyle="None"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="fbank_id" HeaderText="银行卡号">
				...
				</asp:panel><asp:panel id="PanelMod" runat="server" HorizontalAlign="Center" Visible="False">
					<TR>
						<TD width="150" align="right">
					...
					<TR>
						...
						<TD>
							<asp:Label id="lblFuid" Runat="server" Visible="False"></asp:Label></TD>
					</TR>
					<TR>
						<TD width="150" align="right">
					...
					<TR>
						<TD colSpan="4" align="center">
							...
							<asp:Button id="btnCancel" Text=" 取  消 " Runat="server" onclick="btnCancel_Click"></asp:Button></TD>
					</TR>
				</asp:panel></TABLE>
		</form>
	</body>
