							...
							<asp:datagrid id="dgList" runat="server" Width="100%" BorderColor="#E7E7FF" BorderStyle="None"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="详细">
										<ItemTemplate>
											<a href='./BankCardUnbind.aspx?type=edit&Findex=<%# DataBinder.Eval(Container, "DataItem.Findex")%>&Fuid=<%# DataBinder.Eval(Container, "DataItem.Fuid")%>&FBDIndex=<%# DataBinder.Eval(Container, "DataItem.FBDIndex")%>'>
												详细</a>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
