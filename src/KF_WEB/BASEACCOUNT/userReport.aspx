...
<%@ Register TagPrefix="uc1" TagName="commonDataSet" Src="../Control/commonDataSet.ascx" %>
<%@ Page language="c#" Codebehind="userReport.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.BaseAccount.userReport" %>
						...
						<table height="8" cellSpacing="0" cellPadding="1" width="100%" background="../IMAGES/Page/bg_bl.gif"
							...
							<tr background="../IMAGES/Page/bg_bl.gif">
								<td style="HEIGHT: 24px" width="80%" height="24"><font color="#ff0000"><STRONG><FONT color="#ff0000">&nbsp;</FONT></STRONG><IMG height="16" src="../IMAGES/Page/post.gif" width="20">
										用户投诉意见 </font><span class="style6"><FONT color="red">查询</FONT></span>
								</td>
								...
								<TBODY>
									...
									<TR bgColor="#eeeeee">
										...
										<TD colSpan="2"><FONT face="宋体">&nbsp; 精确查询
												...
												条&nbsp; 件：
												<asp:dropdownlist id="ddlCondition" runat="server" Width="131px" onselectedindexchanged="ddlCondition_SelectedIndexChanged">
							...
							<TR>
								<TD bgColor="#ffffff" height="12"><FONT face="宋体">
										<DIV align="left"><asp:datagrid id="dgInfo" runat="server" Width="100%" AutoGenerateColumns="False">
												...
												<Columns>
													<asp:BoundColumn DataField="uin" HeaderText="用户帐号"></asp:BoundColumn>
													<asp:TemplateColumn HeaderText="投诉意见">
														<ItemTemplate>
															<asp:Label runat="server" Text='<%# setConfig.replaceMStr(DataBinder.Eval(Container, "DataItem.cont").ToString()) %>'>
															</asp:Label>
														</ItemTemplate>
													</asp:TemplateColumn>
													<asp:BoundColumn DataField="dttm" HeaderText="日期"></asp:BoundColumn>
												</Columns>
											</asp:datagrid></DIV>
									</FONT>
