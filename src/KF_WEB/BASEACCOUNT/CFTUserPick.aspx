<%@ Page language="c#" Codebehind="CFTUserPick.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.BaseAccount.CFTUserPick" %>
			...
			<table cellSpacing="1" cellPadding="0" width="100%" bgColor="#000000" border="0">
				...
				<tr bgColor="#ffffff">
					...
					<td align="center" background="IMAGES/Page/bk_white.gif" bgColor="#eeeeee" colSpan="3"
						...
						height="20"><font color="blue">财付通用户自助申诉处理</font></td>
				...
				<tr bgColor="#ffffff">
					...
					<td align="center" width="25%" height="20">
						...
						<asp:HyperLink id="hlNewORder" runat="server" Target="_blank" NavigateUrl="CftUserPick.aspx?type=new"
									...
									<table cellSpacing="1" cellPadding="0" width="100%" border="0">
										...
										<tr align="center">
											...
											<td colSpan="2"><asp:radiobuttonlist id="rblist1" runat="server">
													...
													<asp:ListItem Value="3">转后台处理</asp:ListItem>
