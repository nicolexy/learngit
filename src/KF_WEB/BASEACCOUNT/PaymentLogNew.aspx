...
<%@ Page language="c#" Codebehind="PaymentLogNew.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.BaseAccount.PaymentLogNew" %>
				...
				<asp:datagrid id=DataGrid1 runat="server" DataMember="Table1" AutoGenerateColumns="False" DataSource="<%# DS_Payment %>">
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="当前状态">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label1" runat="server" Text='<%#  setConfig.convertCurrentState(DataBinder.Eval(Container, "DataItem.Fstate").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="交易类型">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label2" runat="server" Text='<%# setConfig.convertTradeType(DataBinder.Eval(Container, "DataItem.Ftype").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="类别（科目）">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label3" runat="server" Text='<%# setConfig.convertTCfSubject(DataBinder.Eval(Container, "DataItem.Fsubject").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="交易的金额">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label4" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FnumStr") %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="交易标记">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label5" runat="server" Text='<%# setConfig.convertTradeSign(DataBinder.Eval(Container, "DataItem.Fsign").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						...
						<asp:TemplateColumn HeaderText="实际打款银行">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label6" runat="server" Text='<%# setConfig.convertbankType(DataBinder.Eval(Container, "DataItem.Fbank_type").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						...
						<asp:TemplateColumn HeaderText="币种的种类">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label7" runat="server" Text='<%# setConfig.convertMoney_type(DataBinder.Eval(Container, "DataItem.Fcurtype").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
