...
<%@ Page language="c#" Codebehind="RefundNew.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.CFT.KF.KF_Web.BaseAccount.RefundNew" %>
				...
				<asp:DataGrid id="DataGrid1" runat="server" DataSource="<%# dataSet1 %>" AutoGenerateColumns =False >
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="退款方式">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label1" runat="server" Text='<%# setConfig.cPay_type(DataBinder.Eval(Container, "DataItem.Fpay_type").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						...
						<asp:TemplateColumn HeaderText="卖家银行的类型">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label3" runat="server" Text='<%# setConfig.convertbankType(DataBinder.Eval(Container, "DataItem.Fsale_bank_type").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="卖家的银行类型">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label4" runat="server" Text='<%# setConfig.convertbankType(DataBinder.Eval(Container, "DataItem.Fsale_bankid").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="退款的状态">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label5" runat="server" Text='<%# setConfig.cRefundState(DataBinder.Eval(Container, "DataItem.Fstate").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="退款单的状态">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label6" runat="server" Text='<%# setConfig.cRlistState(DataBinder.Eval(Container, "DataItem.Flstate").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="退还给买家金额">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label7" runat="server" Text='<%# setConfig.FenToYuan(DataBinder.Eval(Container, "DataItem.Fpaybuy").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="退还给卖家金额">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label8" runat="server" Text='<%# setConfig.FenToYuan(DataBinder.Eval(Container, "DataItem.Fpaysale").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="交易手续费">
							...
							<ItemStyle Wrap="False"></ItemStyle>
							<ItemTemplate>
								<asp:Label ID="Label9" runat="server" Text='<%# setConfig.FenToYuan(DataBinder.Eval(Container, "DataItem.Fprocedure").ToString()) %>'>
								</asp:Label>
							</ItemTemplate>
						</asp:TemplateColumn>
