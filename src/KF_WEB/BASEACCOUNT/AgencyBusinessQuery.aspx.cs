...
namespace TENCENT.OSS.CFT.KF.KF_Web.BaseAccount
{
	...
	/// </summary>
	public partial class AgencyBusinessQuery : System.Web.UI.Page
	{
		...
		private void BindData(int index)
		{
           ...
           // string spid = "";
           // string alias = this.txtAlias.Text.Trim();
            ...
            //    if (alias != "")
             //   {
             //       spid = qs.QuerySpidOrSpalias("", alias,""); //通过别名查询商户号
            //    }
            //    if (string.IsNullOrEmpty(spid))
              //  {
            //        spid = txtSpid.Text.ToString();
            //    }
                
            //    ds = qs.QueryAgencyBySpid(spid);
           // }
		...
		private void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			if(e.CommandName == "Select")
			{
				try
				{
                    ...
                    //if (sflag == "2")
                   //// {
                   //     ds = qs.QueryAgencyInfoById(e.Item.Cells[0].Text);
                   // }
                    //else 
                   // {
