<%@ Page language="c#" Codebehind="logOnUserNew.aspx.cs" AutoEventWireup="True" Inherits="TENCENT.OSS.C2C.KF.KF_Web.BaseAccount.logOnUserNew" %>
					...
					<TR>
						<TD bgColor="#666666">
							<TABLE id="Table2" cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
								<TR bgColor="#e4e5f7">
									<TD background="../IMAGES/Page/bg_bl.gif" height="20"><FONT color="#ff0000"><IMG height="16" src="../IMAGES/Page/post.gif" width="20">&nbsp;&nbsp;销户历史明细
										</FONT>
									</TD>
								</TR>
								<TR>
							...
							<TABLE style="HEIGHT: 119px" cellSpacing="1" cellPadding="0" width="100%" align="center"
								...
								<TR>
									...
									<TD style="WIDTH: 299px; HEIGHT: 33px" bgColor="#ffffff" height="33">
                                        <FONT face="宋体">
											<asp:textbox id="TextBoxBeginDate" runat="server" BorderStyle="Groove" onClick="WdatePicker()"  CssClass="Wdate" >2006-01-01</asp:textbox>
									    </FONT>
									</TD>
									...
									<TD colspan="2" style="HEIGHT: 33px" bgColor="#ffffff" height="33">
                                        <FONT face="宋体">
											<asp:textbox id="TextBoxEndDate" runat="server" BorderStyle="Groove" onClick="WdatePicker()"  CssClass="Wdate" ></asp:textbox>
									    </FONT>
									</TD>
								</TR>
								<TR>
